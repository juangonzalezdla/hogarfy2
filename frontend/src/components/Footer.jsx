    ...
    <footer className='bg-oscuro text-blanco px-12 py-12 max-md:px-4'>
      <div className='w-full max-w-[1400px] my-0 mx-auto flex justify-between max-md:flex-col max-md:gap-8'>
        ...
        <div className='flex flex-col justify-center items-center'>
          ...
          <Link to='/legal/sobre-nosotros' className='mb-1 hover:underline' target='_blank'>
            ¿Quiénes somos?
          </Link>
          <Link to='/legal/preguntas-frecuentes' className='mb-1 hover:underline' target='_blank'>
            Preguntas frecuentes
          </Link>
          <Link to='/legal/terminos-condiciones' className='mb-1 hover:underline' target='_blank'>
            Términos y condiciones
          </Link>
          <Link to='/legal/privacidad' className='mb-1 hover:underline' target='_blank'>
